...
<div class="conteudo-1">
    ...
    <div id="imagem-2"> 
         <a href=""><img src="imagens/Vector.png" width="45px"></a> 
         <a href=""><img src="imagens/facebook-svgrepo-com (1) 1.png" width="45px" ></a> 
         <a href=""><img src="imagens/whatsapp-svgrepo-com 1 (1).png" width="45px" ></a> 
...
<div class="container-conteudo-2">
    <div class="parte-1">
        ...
        <br>
        <a href="cadastro.html" class="link">QUERO ME TORNAR UM <span id="cor">RAYCUTS</span></a>
        <br>
        <a href="pesquisa.profissional.html" class="link">ENCONTRAR UM PROFISSIONAL</a>
    </div>
...
<div class="container-conteudo-3">
    ...
    <br>
    <p id="paragrafo-conteudo-3">Na Raycuts você cliente tem a facilidade de encontrar profissionais de acordo com sua
        localização e serviço escolhido, pelo seu celular, notebook ou PC, tudo de forma simples, rápida e melhor: gratuita.
        <br> faça já o seu cadastro e se torne um cliente <span id="cor">Raycuts</span>.
    </p>
    <a href="cliente.html" class="link-cliente">QUERO ME TORNAR UM CLIENTE <span id="cor">RAYCUTS</span></a>
    
    </div>
</div>
    <div class="container-conteudo-4">
    <div class="empresa">
<h2 class="titulo">Para Empresa</h2>
<BR>
        <p id="paragrafo-4">Na Raycuts você empresa ou profissional divulga seu trabalho, organiza o
        ...
        <a href="profissional.html" id="link-empresa">QUERO ME TORNAR UM <span id="cor">RAYCUTS</span></a>
<br>
...
importam com a beleza e o bem-estar. 
    ...
    <div id="botao"><a href="cadastro.html">Cadastre-se</a></div>
    ...
    <div class="rodape">
        ...
        <div class="link-1">
            <a id="cor-2"  href="home.html">Inicio</a >
            <a id="cor-2" href="">Promoções</a >
            <a id="cor-2" href="login.html">Login</a >
            <a id="cor-2" href="cadastro.html">Cadastro</a >
        </div>

        <div class="link-1">
            <a id="cor-2" href="servico.html">Serviços</a >
            <a id="cor-2" href="">Agendamentos</a >
            <a id="cor-2" href="profissional.html">profissionais</a >
        </div>

        <div class="link-1">
            <a id="cor-2" href="#conteudo-5">Sobre nós</a >
            <a id="cor-2" href="">Contato</a >
